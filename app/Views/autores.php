        ...
        <table class="table mt-5 table-hover table-bordered">
            ...
            <tbody>
                ...
                foreach ($datos as $estudiante) {
                    ?>
                    <tr>
                        <td><?php echo ($estudiante['codigo_autor']) ?></td>
                        ...
                        <td class="d-flex justify-content-center gap-2 ">
                            ...
                            <a href="<?= base_url('update_autor/') . $estudiante['codigo_autor']; ?>" class="btn btn-outline-dark"><i class="bi bi-pencil"></i></a>
                            <a href="<?= base_url('eliminar_autor/') . $estudiante['codigo_autor']; ?>" class="btn btn-outline-danger"><i class="bi bi-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                }
